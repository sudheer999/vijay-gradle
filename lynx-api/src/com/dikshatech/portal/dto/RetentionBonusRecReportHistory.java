...
public class RetentionBonusRecReportHistory implements Serializable{

	
	
	
	/** 
	 * This attribute maps to the column ID in the RETENTION_BONUS_REC_REPORT_HISTORY table.
	 */
	private int		id;
	/** 
	 * This attribute maps to the column REP_ID in the RETENTION_BONUS_REC_REPORT_HISTORY table.
	 */
	private int		repId;
	
	/** 
	 * This attribute maps to the column QUATERELY_BONUS in the RETENTION_BONUS_REC_REPORT_HISTORY table.
	 */
	...
	/** 
	 * This attribute maps to the column CURRENCY_TYPE in the RETENTION_BONUS_REC_REPORT_HISTORY table.
	 */
	private short	currencyType;
	/** 
	 * This attribute maps to the column MODIFIED_BY in the RETENTION_BONUS_REC_REPORT_HISTORY table.
	 */
	private String	modifiedBy;
	/** 
	 * This attribute maps to the column MODIFIED_ON in the RETENTION_BONUS_REC_REPORT_HISTORY table.
	 */
	private Date	modifiedOn;
	/** 
	 * This attribute maps to the column COMMENTS in the RETENTION_BONUS_REC_REPORT_HISTORY table.
	 */
	private String	comments;
	/** 
	 * This attribute maps to the column IS_DELETED in the RETENTION_BONUS_REC_REPORT_HISTORY
	 *  table.
	 */
	private short	type;
	...
	/**
	 * Method 'RetentionBonusRecReportHistory'
	 * 
	 */
	public RetentionBonusRecReportHistory() {}

	public RetentionBonusRecReportHistory(int repId, String qbonus,String cbonus, short currencyType,  String modifiedBy, Date modifiedOn, String comments, short type,String qAmount,String cAmount, String qAmountInr,String cAmountInr, String total,String currencyName) {
		super();
		this.repId = repId;
		this.qBonus = qbonus;
		this.cBonus = cbonus;
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof RetentionBonusRecReportHistory)){ return false; }
		final RetentionBonusRecReportHistory _cast = (RetentionBonusRecReportHistory) _other;
	 ...
	 * Method 'createPk'
	 * 
	 * @return RetentionDepPerdiemReportHistoryPk
	 */
	public RetentionBonusRecReportHistoryPk createPk() {
		return new RetentionBonusRecReportHistoryPk(id);
	}
	...
	public String toString() {
		return "RetentionBonusRecReportHistory [id=" + id + ",repId=" + repId + ", "+ (qBonus != null ? "qBonus=" + qBonus + ", " : "") +(cBonus != null ? "cBonus=" + cBonus + ", " : "") + "currencyType=" + currencyType + ", " + (modifiedBy != null ? "modifiedBy=" + modifiedBy + ", " : "") + (modifiedOn != null ? "modifiedOn=" + modifiedOn + ", " : "") + (comments != null ? "comments=" + comments + ", " : "") + "type=" + type + ", " + (qAmount != null ? "qAmount=" + qAmount + ", " : "")
	...
	public Map<String, String> toHashMap() {
		...
		map.put("Type", String.valueOf((short) type));
