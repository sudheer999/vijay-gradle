...
/** 
 * This class represents the primary key of the PAYSLIP table.
 */
public class PayslipPk implements Serializable
{
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof PayslipPk)) {
			return false;
		}
		
		final PayslipPk _cast = (PayslipPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.dikshatech.portal.dto.PayslipPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
