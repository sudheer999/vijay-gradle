...
public class ResourceStatusPk {
	 ...
	 * @param id
	 */
	public ResourceStatusPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof ResourceStatusPk)) {
			return false;
		}
		
		final ResourceStatusPk _cast = (ResourceStatusPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.dikshatech.portal.dto.ResourceStatusPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
