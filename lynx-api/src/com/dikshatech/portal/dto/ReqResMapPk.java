...
public class ReqResMapPk {
	 ...
	 * @param id
	 */
	public ReqResMapPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof ReqResMapPk)) {
			return false;
		}
		
		final ReqResMapPk _cast = (ReqResMapPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.dikshatech.portal.dto.ReqResMapPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
