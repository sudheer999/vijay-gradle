...
public class BonusReconciliation extends PortalForm implements Serializable  {

	/**
	 * This attribute maps to the column ID in the BONUS_RECONCILIATION table.
	 */
	protected int		id;
	/**
	 * This attribute maps to the column ESR_MAP_ID in the BONUS_RECONCILIATION table.
	 */
	protected int		esrMapId;
	/**
	 * This attribute maps to the column TERM in the BONUS_RECONCILIATION table.
	 */
	protected String	term;
	/**
	 * This attribute maps to the column MONTH in the BONUS_RECONCILIATION table.
	 */
	protected String	month;
	/**
	 * This attribute maps to the column YEAR in the BONUS_RECONCILIATION table.
	 */
	protected int		year;
	/**
	 * This attribute maps to the column SUBMITTED_ON in the BONUS_RECONCILIATION table.
	 */
	protected Date		submittedOn;
	/**
	 * This attribute maps to the column COMPLETED_ON in the BONUS_RECONCILIATION table.
	 */
	protected Date		completedOn;
	/**
	 * This attribute maps to the column STATUS in the BONUS_RECONCILIATION table.
	 */
	protected String	status;
	/**
	 * This attribute maps to the column HTML_STATUS in the BONUS_RECONCILIATION table.
	 */
	protected String	htmlStatus;
	
	/**
	 * This attribute maps to the column ID,CURRENCY_TYPE,QUA_AMOUNT,COM_AMOUNT in the bonus_rec_exchange_ratetable.
	 */
	...
	/**
	 * Method 'BonusReconciliation'
	 */
	public BonusReconciliation() {}
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof BonusReconciliation)){ return false; }
		final BonusReconciliation _cast = (BonusReconciliation) _other;
	 ...
	 */
	public BonusReconciliationPk createPk() {
		return new BonusReconciliationPk(id);
	}
	...
	public String toString() {
		...
		ret.append("com.dikshatech.portal.dto.BonusReconciliation: ");
		ret.append("id=" + id);
