...
/** 
 * This class represents the primary key of the APPRAISAL table.
 */
public class AppraisalPk implements Serializable
{
	 ...
	 * @param id
	 */
	public AppraisalPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof AppraisalPk)) {
			return false;
		}
		
		final AppraisalPk _cast = (AppraisalPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.dikshatech.portal.dto.AppraisalPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
