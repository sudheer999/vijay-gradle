...
public class RetentionBonusComponents implements Serializable{

	
	
	/** 
	 * This attribute maps to the column ID in the RETENTION_DEP_PERDIEM_COMPONENTS  table.
	 */
	protected Integer	id;
	/** 
	 * This attribute maps to the column REP_ID in the RETENTION_DEP_PERDIEM_COMPONENTS  table.
	 */
	protected Integer	repId;
	/** 
	 * This attribute maps to the column TYPE in the RETENTION_DEP_PERDIEM_COMPONENTS  table.
	 */
	protected Short		type;
	/** 
	 * This attribute maps to the column REASON in the RETENTION_DEP_PERDIEM_COMPONENTS  table.
	 */
	protected String	reason;
	/** 
	 * This attribute maps to the column CURRENCY in the RETENTION_DEP_PERDIEM_COMPONENTS  table.
	 */
	protected Integer	currency;
	/** 
	 * This attribute maps to the column AMOUNT in the RETENTION_DEP_PERDIEM_COMPONENTS  table.
	 */
	...
	/** 
	 * This attribute maps to the column ADDED_BY in the RETENTION_DEP_PERDIEM_COMPONENTS table.
	 */
	protected String	addedBy;
	/** 
	 * This attribute maps to the column ADDED_ON in the RETENTION_DEP_PERDIEM_COMPONENTS table.
	 */
	protected Date		addedOn;
	/** 
	 * This attribute maps to the column COMMENTS in the RETENTION_DEP_PERDIEM_COMPONENTS table.
	 */
	protected String	comments;

	/**
	 * Method 'RetentionBonusComponents'
	 * 
	 */

	public RetentionBonusComponents() {}
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof RetentionBonusComponents)){ return false; }
		final RetentionBonusComponents _cast = (RetentionBonusComponents) _other;
	 ...
	 */
	public RetentionBonusComponentsPk createPk() {
		return new RetentionBonusComponentsPk(id);
	}
	...
	public String toString() {
		...
		ret.append("com.dikshatech.portal.dto.RetentionBonusComponents: ");
		ret.append("id=" + id);
