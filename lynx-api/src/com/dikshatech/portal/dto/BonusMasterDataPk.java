...
public class BonusMasterDataPk {
	protected int id;
	 ...
	 * @param id
	 */
	public BonusMasterDataPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof BonusMasterDataPk)) {
			return false;
		}
		
		final BonusMasterDataPk _cast = (BonusMasterDataPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.dikshatech.portal.dto.BonusMasterDataPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
