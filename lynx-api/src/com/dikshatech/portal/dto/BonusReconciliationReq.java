...
public class BonusReconciliationReq implements Serializable {
	
	/** 
	 * This attribute maps to the column ID in the BONUS_RECONCILIATION_REQ table.
	 */
	protected int id;

	/** 
	 * This attribute maps to the column BR_ID in the BONUS_RECONCILIATION_REQ table.
	 */
	protected int bonusId;

	/** 
	 * This attribute maps to the column SEQ_ID in the BONUS_RECONCILIATION_REQ table.
	 */
	protected int seqId;

	/** 
	 * This attribute maps to the column ASSIGNED_TO in the BONUS_RECONCILIATION_REQ table.
	 */
	protected int assignedTo;

	/** 
	 * This attribute maps to the column RECEIVED_ON in the BONUS_RECONCILIATION_REQ table.
	 */
	protected Date receivedOn;

	/** 
	 * This attribute maps to the column SUBMITTED_ON in the BONUS_RECONCILIATION_REQ table.
	 */
	protected Date submittedOn;
	
	/** 
	 * This attribute maps to the column IS_ESCALATED in the BONUS_RECONCILIATION_REQ table.
	 */
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof BonusReconciliationReq)) {
			return false;
		}
		
		final BonusReconciliationReq _cast = (BonusReconciliationReq) _other;
		if (id != _cast.id) {
			return false;
		}
	 ...
	 */
	public BonusReconciliationReqPk createPk()
	{
		return new BonusReconciliationReqPk(id);
	}
	...
	public String toString()
	{
		...
		ret.append( "com.dikshatech.portal.dto.BonusReconciliationReq: " );
		ret.append( "id=" + id );
