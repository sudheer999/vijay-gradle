...
/** 
 * This class represents the primary key of the CALENDAR table.
 */
public class CalendarPk implements Serializable
{
	 ...
	 * @param id
	 */
	public CalendarPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof CalendarPk)) {
			return false;
		}
		
		final CalendarPk _cast = (CalendarPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.dikshatech.portal.dto.CalendarPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
