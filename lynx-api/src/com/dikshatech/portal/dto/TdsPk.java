...
/** 
 * This class represents the primary key of the TDS table.
 */
public class TdsPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof TdsPk)) {
			return false;
		}
		
		final TdsPk _cast = (TdsPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.dikshatech.portal.dto.TdsPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
