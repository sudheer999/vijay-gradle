...
public class RetentionBonusMasterData implements Serializable{
...
private String rBonus;
	 ...
	 * 
	 */
	public RetentionBonusMasterData() {
	}
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof RetentionBonusMasterData)) {
			return false;
		}

		final RetentionBonusMasterData _cast = (RetentionBonusMasterData) _other;
		if (id != _cast.id) {
			return false;
		}
		...
		if (rBonus == null ? _cast.rBonus != rBonus : !rBonus
				.equals(_cast.rBonus)) {
			return false;
		}
	...
	public int hashCode() {
		...
		if (qBonus != null) {
			...
			_hashCode = 29 * _hashCode + rBonus.hashCode();
		}
	 ...
	 */
	public RetentionBonusMasterDataPk createPk() {
		return new RetentionBonusMasterDataPk(id);
	}
	...
	public String toString() {
		...
		ret.append("com.dikshatech.portal.dto.RetentionBonusMasterData: ");
		ret.append("id=" + id);
		ret.append(", userId=" + userId);
		ret.append(", qBonus=" + qBonus);
		ret.append(", cBonus=" + cBonus);
		ret.append(", rBonus=" + rBonus);
