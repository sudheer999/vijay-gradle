...
public class CandidateChecklistDocsDaoImpl extends AbstractDAO implements CandidateChecklistDocsDao
{
	/** 
...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	...
	protected static final Logger logger = Logger.getLogger( CandidateChecklistDocsDaoImpl.class );

	/** 
	 * All finder methods in this class use this SELECT constant to build their queries
	 */
	protected final String SQL_SELECT = "SELECT ID, NAME, PARENT_ID FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( ID, NAME, PARENT_ID ) VALUES ( ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET ID = ?, NAME = ?, PARENT_ID = ? WHERE ID = ?";
	...
	public CandidateChecklistDocsPk insert(CandidateChecklistDocs dto) throws CandidateChecklistDocsDaoException
	{
		...
		try {
			...
			throw new CandidateChecklistDocsDaoException( "Exception: " + _e.getMessage(), _e );
		}
		finally {
	...
	{
		CandidateChecklistDocs ret[] = findByDynamicSelect( SQL_SELECT + " WHERE ID = ?", new Object[] {  new Integer(id) } );
	...
	/**
	 * Method 'CandidateChecklistDocsDaoImpl'
	 * 
	 */
	public CandidateChecklistDocsDaoImpl()
	{
	}
	 ...
	 * @param userConn
	 */
	public CandidateChecklistDocsDaoImpl(final java.sql.Connection userConn)
	{
	...
	{
		return "CANDIDATE_CHECKLIST_DOCS";
	}

	/** 
	 * Fetches a single row from the result set
	 */
	protected CandidateChecklistDocs fetchSingleResult(ResultSet rs) throws SQLException
	{
		if (rs.next()) {
			CandidateChecklistDocs dto = new CandidateChecklistDocs();
			populateDto( dto, rs);
			return dto;
		} else {
			return null;
	 ...
	 */
	protected CandidateChecklistDocs[] fetchMultiResults(ResultSet rs) throws SQLException
	{
		Collection<CandidateChecklistDocs> resultList = new ArrayList<CandidateChecklistDocs>();
		while (rs.next()) {
			CandidateChecklistDocs dto = new CandidateChecklistDocs();
			populateDto( dto, rs);
			resultList.add( dto );
		...
		CandidateChecklistDocs ret[] = new CandidateChecklistDocs[ resultList.size() ];
	 ...
	 */
	protected void populateDto(CandidateChecklistDocs dto, ResultSet rs) throws SQLException
	{
	 ...
	 */
	protected void reset(CandidateChecklistDocs dto)
	{
	}
