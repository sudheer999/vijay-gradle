...
public class CurrencyTypeDaoImpl extends AbstractDAO implements CurrencyTypeDao
{
	/** 
...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	...
	protected static final Logger logger = Logger.getLogger( CurrencyTypeDaoImpl.class );
	...
	public CurrencyTypePk insert(CurrencyType dto) throws CurrencyTypeDaoException
	{
		...
		try {
			...
			throw new CurrencyTypeDaoException( "Exception: " + _e.getMessage(), _e );
		}
		finally {
	...
	{
		CurrencyType ret[] = findByDynamicSelect( SQL_SELECT + " WHERE ID = ?", new Object[] {  new Integer(id) } );
	 ...
	 * @param userConn
	 */
	public CurrencyTypeDaoImpl(final java.sql.Connection userConn)
	{
	 ...
	 */
	protected CurrencyType fetchSingleResult(ResultSet rs) throws SQLException
	{
		if (rs.next()) {
			CurrencyType dto = new CurrencyType();
			populateDto( dto, rs);
			return dto;
		} else {
			return null;
	 ...
	 */
	protected CurrencyType[] fetchMultiResults(ResultSet rs) throws SQLException
	{
		Collection<CurrencyType> resultList = new ArrayList<CurrencyType>();
		while (rs.next()) {
			CurrencyType dto = new CurrencyType();
			populateDto( dto, rs);
			resultList.add( dto );
		...
		CurrencyType ret[] = new CurrencyType[ resultList.size() ];
	 ...
	 */
	protected void populateDto(CurrencyType dto, ResultSet rs) throws SQLException
	{
	 ...
	 */
	protected void reset(CurrencyType dto)
	{
	}
